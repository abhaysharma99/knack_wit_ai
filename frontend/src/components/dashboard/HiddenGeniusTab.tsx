      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        ...
        >
          ...
          <div className="text-2xl font-bold text-genius-400">
            {geniuses.length > 0
              ? Math.round(
                  (geniuses.reduce((acc, g) => acc + g.future_potential_score, 0) / geniuses.length) * 100,
                )
              : '—'}
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="text-2xl font-bold text-genius-400">
            {geniuses.length > 0
              ? Math.round(Math.max(...geniuses.map((g) => g.true_talent_score)) * 100)
              : '—'}
          </div>
        </motion.div>
      </div>
      ...
      <div className="space-y-3">
        {geniuses.length === 0 && (
          <p className="text-center text-white/40 py-10">
            No hidden geniuses found yet. Run a search to analyze candidates.
          </p>
        )}
